			...
			<div>
								...
								return 	<li >
									<div className="summername">{item.name}
										...
										<div className="sunimg">
											<img src={require('../../../../style/img/light.png')}  />
										</div>
										<div className="listing listings">
											<ol>
												<li>定时开机：{item.startingup}</li>
												<li>定时关机：{item.machine}</li>
				...
				>
					...
					>
						...
						<Form.Item   label="定时关机"  style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.2)' }}>
						    <Form.Item
						        style={{ display: 'inline-block', width: '30%' }}
						    >
						    ...
						    <Form.Item name="machine" style={{ display: 'inline-block', width: '70%' }}>
						...
						<Form.Item name="windspeed" label="风速档位">
						    <Radio.Group>
