...
/**
 * @author zph
 * @description iot_ts_kv 中以energy为维度的
 * 最近一周的切片事实表视图
 * @date 2022-07-01
 */
@Entity
...
@Table(name = "iot_ts_kv_energy_lastweek_view")
public class IotTsKvEnergyLastWeekView implements Serializable {
    ...
    public IotTsKvEnergyLastWeekView() {
    }
