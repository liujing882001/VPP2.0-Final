...
public class RealTimeDataRequest {
    ...
    @ApiModelProperty(value = "事件类型", required = true, allowableValues = "RTData")
    private String eventType;

    @ApiModelProperty(value = "父资源 id，为 null 时表示第二级", required = false)
    private String parentResourceId;

    @ApiModelProperty(value = "页码，若不上传该字段，默认为第 1页", required = true)
    private int page = 1;

    @ApiModelProperty(value = "每页显示最大条数，若不上传该字段，则默认为 100", required = true)
